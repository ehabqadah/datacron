...
import de.fhg.iais.kd.datacron.trajectories.cleaning.table.metadata.TBMTrajectoriesOutputNDS;

public class OutputProviderNDS extends AbstractDataProvider<TBTrajectoriesOutput> {

	private static final long serialVersionUID = 3042437178960616961L;

	@Inject
	public OutputProviderNDS( //
