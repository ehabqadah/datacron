...
import de.fhg.iais.kd.datacron.trajectories.cleaning.table.metadata.TBMTrajectoriesOutputND;

public class OutputProviderND extends AbstractDataProvider<TBTrajectoriesOutput> {

	private static final long serialVersionUID = -5556975391499283873L;

	@Inject
	public OutputProviderND( //
